...
function Cart() {
  ...
  const [total, setTotal] = useState(0)
    ...
    if(carts.length===0){
      return <h1 className=' h-[66vh] flex justify-center items-center text-4xl'>Cart is Empty</h1>
    }
          ...
          <div className="w-3/4shadow-md my-10 flex-wrap">
            <div className=" bg-white px-10 py-1">
              <div className="flex justify-between border-b pb-8">
                ...
                <h2 className="font-semibold text-2xl">Items: {carts.length}</h2>
              </div>
            ...
            <div id="summary" className="w-2/4 px-8 py-10 container">
              ...
              <div className="flex flex-wrap justify-between mt-10">
                <span className="font-bold text-sm uppercase">Items: {carts?.length}</span>
              ...
              <div className="border-t mt-8">
                ...
                <Link to='/checkout'
                 className="bg-indigo-500 font-bold tracking-wide hover:bg-indigo-600 py-3 p-2 text-sm text-white uppercase w-full">Checkout</Link>
              </div>
            </div>
          </div>
       </div>
